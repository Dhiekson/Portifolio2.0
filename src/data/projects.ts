...
export const projects: Project[] = [
...
},
  {
    id: 'dns-secure',
    name: 'DNS Secure',
    description: 'VPN Local para bloqueio de anúncios e proteção.',
    fullDescription: 'Aplicativo que usa VPN Local para bloquear anúncios, rastreadores e domínios maliciosos em nível de DNS.',
    objective: 'Proteger a privacidade do usuário e proporcionar navegação mais limpa e segura.',
    problem: 'Anúncios excessivos e rastreamento de dados em apps e sites.',
    solution: 'VPN Local que intercepta requisições DNS e bloqueia domínios maliciosos.',
    features: [
      'VPN Local transparente',
      'Bloqueio de anúncios',
      'Proteção contra rastreadores',
      'Listas de domínios atualizáveis',
      'Estatísticas de bloqueio'
    ],
    technologies: ['React Native', 'TypeScript', 'VPN Service'],
    tools: ['Android Studio', 'Xcode', 'Charles Proxy'],
    database: ['SQLite'],
    challenges: [
      'Implementação de serviço VPN',
      'Performance em dispositivos low-end',
      'Manutenção de listas de bloqueio'
    ],
    learnings: [
  ...
  },
  {
    id: 'ia-financeira',
    name: 'IA Financeira',
    description: 'Assistente inteligente para organização financeira.',
    fullDescription: 'Assistente virtual alimentado por IA para ajudar na organização financeira, dar dicas e automatizar tarefas.',
    objective: 'Usar inteligência artificial para otimizar a vida financeira.',
    problem: 'Falta de tempo e conhecimento para organizar finanças.',
    solution: 'Assistente com processamento de linguagem natural.',
    features: [
      'Chat com IA',
      'Análise de gastos',
    ...
    technologies: ['React Native', 'Expo', 'OpenAI', 'Supabase'],
    ...
    year: 2025,
    category: 'IA',
    image: '/images/ia-financeira.png',
    links: {
      github: 'https://github.com/Dhiekson',
    }
  }
